...
describe('OpenWeatherService', () => {
    ...
    it('should getCityForecast from API', () => {
        ...
        const req = httpMock.expectOne(
            `https://api.openweathermap.org/data/2.5/forecast?q=New%20York&units=metric&appId=${OPEN_WEATHER_API_CONFIG.API_KEY}`);
    ...
    it('should getBboxForecast from API', () => {
        ...
        const req = httpMock.expectOne(
            `http://api.openweathermap.org/data/2.5/box/city?bbox=${europeBbox}&units=metric&appId=${OPEN_WEATHER_API_CONFIG.API_KEY}`);
        expect(req.request.method).toBe('GET');
